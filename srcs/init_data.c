...
/*   Updated: 2023/06/29 21:26:36 by noloupe          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_data(int ac, char **av, t_data	**data)
{
	...
	*data = malloc(sizeof(t_data));
	if (!data)
		return (init_data_error(STRUCT, *data, NULL));
